  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-[#475569]">
        {tasks.length} escalated task{tasks.length !== 1 ? 's' : ''}
      </p>
      ...
      {tasks.length === 0 ? (
        <div className="bg-white border border-[#E2E8F0] rounded-[12px] shadow-[0_1px_3px_rgba(0,0,0,0.08)] flex flex-col items-center justify-center py-20">
          ...
          <p className="font-semibold text-[#0F172A]">No escalated tasks</p>
          <p className="text-sm text-[#475569] mt-1">Tasks flagged for escalation will appear here.</p>
        </div>
      ) : (
