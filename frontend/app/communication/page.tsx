...
export default function CommunicationPage() {
  return <ComingSoon icon={<MessageSquare size={40} />} title="Communication" description="Centralise announcements, team updates, and internal communications in one place." />
}
      ...
      <div className="flex flex-col items-center text-center max-w-sm gap-5">
        ...
        <div className="w-full bg-white border border-[#E2E8F0] rounded-[12px] px-5 py-4 text-left">
          ...
          <ul className="flex flex-col gap-2">
            {['Company-wide announcements', 'Team channels & threads', 'Pulse surveys & feedback', 'Town hall & meeting notes'].map((f) => (
