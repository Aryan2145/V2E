...
export default function LearningPage() {
  return <ComingSoon icon={<GraduationCap size={40} />} title="Learning" description="Upskill your team with curated courses, learning paths, and skill assessments." />
}
      ...
      <div className="flex flex-col items-center text-center max-w-sm gap-5">
        ...
        <div className="w-full bg-white border border-[#E2E8F0] rounded-[12px] px-5 py-4 text-left">
          ...
          <ul className="flex flex-col gap-2">
            {['Curated learning paths', 'Course library & integrations', 'Skill gap analysis', 'Completion tracking & certifications'].map((f) => (
